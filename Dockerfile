...
LABEL org.opencontainers.image.description="TOR-only(based), self-destructing Wayland remote desktop"
LABEL org.opencontainers.image.authors="whodx@mozmail.com"
